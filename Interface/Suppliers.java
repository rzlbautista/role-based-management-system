 ...
 public void tb_load() {
     try {
       ...
       try (java.sql.Connection connection = db.mycon();
         ...
         java.sql.ResultSet rs = statement.executeQuery("SELECT * FROM supplier_table")) {
    ...
    private void initComponents() {
        ...
        jLabel35.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGE/Supplies.png"))); // NOI18N
        jLabel35.setText("SUPPLIERS");

        s_search.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        s_search.setForeground(new java.awt.Color(0, 0, 102));
        ...
        search.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.default.focusColor"));
        search.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        search.setForeground(new java.awt.Color(0, 51, 204));
        search.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGE/search 25 x 25.png"))); // NOI18N
        ...
        jPanel21Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addComponent(s_search, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(search)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(s_delete, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(35, 35, 35))
        );
        ...
        s_name.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        s_name.setForeground(new java.awt.Color(0, 0, 102));
        ...
        c_add.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.default.focusColor"));
        c_add.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        c_add.setForeground(new java.awt.Color(0, 51, 204));
        c_add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGE/add 25x25.png"))); // NOI18N
        c_add.setText("ADD");
        ...
        s_update.setBackground(javax.swing.UIManager.getDefaults().getColor("Button.default.focusColor"));
        s_update.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        s_update.setForeground(new java.awt.Color(0, 51, 204));
        s_update.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interface/update 25x25.png"))); // NOI18N
        ...
        customertable.setFont(new java.awt.Font("Segoe UI", 2, 12)); // NOI18N
        customertable.setForeground(new java.awt.Color(0, 0, 102));
        customertable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier ID", "Supplier Name", "Contact No.", "Email"
            }
        ));
        ...
        s_search_tbl.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        s_search_tbl.setForeground(new java.awt.Color(0, 0, 102));
        ...
        s_email.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        s_email.setForeground(new java.awt.Color(0, 0, 102));
        ...
        s_contact.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        s_contact.setForeground(new java.awt.Color(0, 0, 102));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(s_id, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(s_search_tbl, javax.swing.GroupLayout.PREFERRED_SIZE, 221, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(s_name, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addGap(19, 19, 19)
                                        .addComponent(s_email, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(s_contact, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addComponent(c_add, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(c_add, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(s_update, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
String contactNo = s_contact.getText(); // Field for contact number
String email = s_email.getText(); // Field for email

try {
    Statement s = db.mycon().createStatement();
    s.executeUpdate("INSERT INTO supplier_table (supplier_id, supplier_name, contact_no, email) " +
                    "VALUES ('" + id + "', '" + sname + "', '" + contactNo + "', '" + email + "')");
    JOptionPane.showMessageDialog(null, "Customer Added");
} catch (SQLException e) {
    System.out.println(e);
}
tb_load(); // Reload the table after adding the customer
...
// Search button code
String csearch = s_search.getText();

try (java.sql.Connection connection = db.mycon();
     java.sql.Statement statement = connection.createStatement();
     java.sql.ResultSet rs = statement.executeQuery("SELECT * FROM supplier_table WHERE supplier_id = '" + csearch + "'")) {

    if (rs.next()) {
        s_name.setText(rs.getString("supplier_name"));
        s_contact.setText(rs.getString("contact_no")); // Assuming you have a field for contact number
        s_email.setText(rs.getString("email")); // Assuming you have a field for email
    } else {
    ...
    private void s_search_tblKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_s_search_tblKeyReleased
        ...
        String sname = s_search_tbl.getText();
        ...
        try {
         ...
         java.sql.Statement statement = connection.createStatement();
         java.sql.ResultSet rs = statement.executeQuery("SELECT * FROM supplier_table WHERE supplier_name LIKE '%" + sname + "%' OR supplier_id LIKE '%" + sname + "%'");
...
String contactNo = s_contact.getText(); // Ensure you have a field for this
String email = s_email.getText(); // Ensure you have a field for this

  
try {
    Statement s = db.mycon().createStatement();
    s.executeUpdate("UPDATE supplier_table SET supplier_name = '" + supplierName + 
...
tb_load();
    ...
    // Delete button code
String id = s_search.getText(); // Get the customer ID to delete
try {
    java.sql.Connection connection = db.mycon();
    java.sql.Statement statement = connection.createStatement();
    // Change the table name to match your actual table name (e.g., customer_table)
    statement.executeUpdate("DELETE FROM supplier_table WHERE supplier_id = '" + id + "'");
    JOptionPane.showMessageDialog(null, "Data Deleted");
} catch (SQLException e) {
    System.out.println(e);
}

tb_load(); // Refresh the table to reflect changes
    ...
    private void customertableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_customertableMouseClicked
        ...
        String sid = customertable.getValueAt(r, 1).toString();
        String sname = customertable.getValueAt(r, 2).toString();
        String scontact = customertable.getValueAt(r, 3).toString();
        String semail = customertable.getValueAt(r, 4).toString();
       
        
        s_id.setText(sid);
        s_name.setText(sname);
        s_contact.setText(scontact);
...
private String getStringValue(int row, int col) {
    Object value = customertable.getValueAt(row, col);
